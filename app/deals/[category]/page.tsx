...
import { deals, tools, categories, getCategorySlug, getCategoryFromSlug, getDealsByCategory } from '@/lib/data/mockData';
...
export default function DealsCategoryPage({ params }: { params: { category: string } }) {
  ...
  const filteredDeals = getDealsByCategory(category);
      ...
      <Container>
        <div className="py-12">
          ...
          <div className="mb-4 text-sm text-gray-600">
            Showing {filteredDeals.length} deals in {category}
          </div>
                      ...
                      <tr key={deal.deal_id} className="border-b border-gray-100 hover:bg-gray-50">
                        ...
                        <td className="py-4 pl-4 hidden sm:table-cell">
                          <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="inline-flex items-center gap-1.5 text-xs font-medium text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-md whitespace-nowrap transition-colors"
                          >
                            Claim Deal
                          </a>
                        </td>
